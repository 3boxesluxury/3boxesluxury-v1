...
import { Search, ShoppingCart, Package, Menu, X, LogIn, LogOut, User, Shield, Gift, Sparkles, Smartphone, ExternalLink } from 'lucide-react';
...
export function Header() {
  ...
  const handleSearch = useCallback(
    (e: React.FormEvent) => {
      ...
      setCategory(null);
      setView('home');
      // ProductGrid will auto-scroll to itself when it sees the search query change
    },
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-amber-900/30 bg-stone-950/95 backdrop-blur-md">
      <div className="container mx-auto px-4">
        <div className="flex h-40 items-center justify-between gap-4">
          {/* Logo */}
          <button
            onClick={() => {
              setView('home');
            ...
            className="flex-shrink-0 flex items-center gap-3 group outline-none focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 active:outline-none border-0 bg-transparent"
          >
          ...
          <div className="flex items-center gap-2">
            {/* Get App / Open App Button — ALWAYS visible */}
            <Button
              variant="outline"
              size="sm"
