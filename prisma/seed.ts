...
const categories = [
  ...
  },
  {
    name: "Home & Living",
    slug: "home-living",
    description: "Luxurious home decor and lifestyle accessories",
...
const products = [
  ...
  {
    name: "Aurelia Gold Hand Chain Bracelet – Slave Bracelet with Ring",
    slug: "aurelia-gold-hand-chain-bracelet-slave-bracelet-with-ring",
    description: "Adorn your hands with effortless elegance. The Aurelia Gold Hand Chain Bracelet is a stunning slave bracelet that drapes gracefully from your finger to your wrist, creating a layered, goddess-like effect that turns heads at every occasion. Crafted with a delicate gold-tone satellite chain featuring evenly spaced ball beads, this hand harness combines bohemian charm with modern luxury. The triple-strand wrist design adds dimension and movement, making it a true statement piece. Product Details: Style: Slave bracelet / Hand chain with finger ring Chain Type: Satellite chain with ball beads Strands: Triple-layer wrist chain + single finger-to-wrist chain Finish: 18K gold-tone plating Closure: Adjustable / Lobster clasp Material: Alloy / Brass base Perfect for: Weddings, Mehendi ceremonies, beach holidays, festivals, date nights &amp; gifting.",
    price: 569.0,
...
async function seed() {
  ...
  // Delete existing products and categories (clean slate)
  ...
  for (const prod of products) {
    ...
    // Convert arrays to JSON strings for Prisma String fields
    ...
    await db.product.upsert({
      ...
      update: { ...serializedData, categoryId: category.id, productNumber },
      create: { ...serializedData, categoryId: category.id, productNumber },
    });
  }
